...
Ra = 2; %Radius of stencil around za
Rb = 2; %Radius of stencil around zb
Rc = 2; %Radius of stencil around corner
pa = 1; %Node at which the TR starts from za
pb = 1; %Node at which the TR starts from zb
pc = 1; %Node at which the TR starts from a corner
